...
public class Control implements Serializable {
    ...
    /**
     * This function sets an Chip on the field. Needs to call nextRound()
     * afterwards.
     * 
    ...
    public String getPlayerWonToString() {
        ...
        if (playerWon == 0)
            sb.append("Nobody ");
        else if (bot == null || playerWon == 1)
            sb.append("Player " + playerWon + " ");
        else
            sb.append("The Bot ");
...
//				System.out.println("Three in a Row");
                ...
                if (columnPlayerWin >= 0)
                    column = columnPlayerWin;
            }

            if (!c.setChip(column))
                nextRound(lastColumn, lastRow);
            else
                c.nextRound();
        }

        /**
         * This Method calculates the Column which the Bpt has to set his chip, so the
         * player wont win.
         * 
         * @param x Column
         * @param y Row
