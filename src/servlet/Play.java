...
public class Play extends HttpServlet {
    ...
    /**
     * @param sessionID The ID of the existing Session ID, which you want to join
     *                  (For Online Player mostly)
     */
    protected void doPost(HttpServletRequest request, HttpServletResponse response, String sessionID)
            throws ServletException, IOException {
    ...
    /**
     * Creates a Local Game With Two Player on the given Session. Needs to run
     * getSession(HttpServletRequest request, String sessionID) before
     */
    ...
    /**
     * Creates a Local Game against an Bot on the given Session. Needs to run
     * getSession(HttpServletRequest request, String sessionID) before
     */
    ...
    /**
     * Creates a Online Game With Two Player on the given Session. Needs to run
     * getSession(HttpServletRequest request, String sessionID) before
     */
    ...
    private void printHtmlGame(PrintWriter out, String sessionID) throws IOException {
        ...
        out.println(Constants.VAR_GAME_TABLE + Arrays.deepToString(c.getField()) + Constants.SEMICOLON
                + Constants.CREATE_TABLE);

        if (c.checkGewonnen()) {
            if (c.getPlayerWon() == 1) {
                out.println(Constants.REMOVE_BUTTON + Constants.H1_STATUS_TEXT + "Du hast das Spiel gewonnen!"
                        + Constants.H1_END);

            } else if (c.getPlayerWon() == 2) {
                out.println(
                        Constants.REMOVE_BUTTON + Constants.H1_STATUS_TEXT + "Du hast verloren :( " + Constants.H1_END);
            }
        }

        out.println(Constants.BACK_BUTTON + Constants.BODY_END + Constants.HTML_END);

        out.close();
    }

    /**
     * Prints the HTML Document of Document when you want to join an Online Match so
     * the Browser can show us the Output
     * 
     * @param out       The PrintWriter of the ServletResponse
     * @param sessionID The Session ID of the Match
     */
    private void printHtmlOnlineBtn(PrintWriter out, String sessionID) {
        ...
        out.println(Constants.BODY_START + Constants.BODY_ONLINE_BTN + Constants.BACK_BUTTON + Constants.BODY_END);
    ...
    /**
     * Prints the HTML Document of an New Online Game so the Browser can show us the
     * Output
     * 
     * @param out       The PrintWriter of the ServletResponse
     * @param sessionID The Session ID of the Match
    ...
    private void printHtmlNewOnlineGame(PrintWriter out, String sessionID) {
        out.println(Constants.HTML_START);
        out.println(Constants.BODY_START + Constants.BODY_NEW_ONLINE_GAME_PARAGRAPH_START + sessionID
                + Constants.PARAGRAPH_END + Constants.BACK_BUTTON + Constants.BODY_END);
        out.println(Constants.HTML_END);
    ...
    private void printHtmlHelp(PrintWriter out, String sessionID) {
        out.println(Constants.HTML_START);
        out.println(Constants.BODY_START + Constants.BODY_HELP + Constants.BACK_BUTTON + Constants.BODY_END);
        out.println(Constants.HTML_END);
    ...
    /**
     * Prints the HTML Document of an Existing Online Game so the Browser can show
     * us the Output
     * 
     * @param out       The PrintWriter of the ServletResponse
     * @param sessionID The Session ID of the Match
    ...
    private void printHtmlExistingGame(PrintWriter out, String sessionID) {
        ...
        out.println(Constants.BODY_START + Constants.BODY_EXISTING_GAME + Constants.BACK_BUTTON + Constants.BODY_END);
